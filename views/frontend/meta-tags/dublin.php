...
?>
<!-- Dublin Core meta tags -->
<meta name="DC.Title" content="<?php echo esc_attr( Meta\data()->title() ); ?>" />
<meta name="DC.Description" content="<?php echo esc_attr( Meta\data()->description() ); ?>" />
<meta name="DC.Format" content="text/html" />
<meta name="DC.Identifier" content="<?php echo esc_attr( esc_url( Meta\data()->url() ) ); ?>" />
...
<meta name="DC.Rights" content="<?php echo esc_attr( Meta\data()->copyright() ); ?>" />
