...
$brush_icon_url  = CCD_URL . 'assets/images/theme-brush-icon.svg';
	...
	<div class="dashboard-panel-column-container">
		...
		<div class="dashboard-panel-column dashboard-panel-last">
			...
			<ul>
				...
				<li><a class="dashboard-icon customize-icon-typography" href="<?php echo esc_url( wp_customize_url() . '?url=' . site_url() . '&autofocus[section]=typography_options&return=' . admin_url() ); ?>"><?php _e( 'Design your typography', 'ccdzine' ); ?></a></li>
				<?php if ( current_theme_supports( 'custom-background' ) ) : ?>
				<li><a class="dashboard-icon customize-icon-background" href="<?php echo esc_url( wp_customize_url() . '?url=' . site_url() . '&autofocus[section]=background_image&return=' . admin_url() ); ?>"><?php _e( 'Site background', 'ccdzine' ); ?></a></li>
				<?php endif; ?>
