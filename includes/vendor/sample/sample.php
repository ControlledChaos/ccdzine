 ...
 * Sample plugin
 *
 * Included for demonstration of bundling a plugin in the Controlled Chaos Design plugin.
 *
 * @package  CCDzine
 * @category Core
 * @since    1.0.0
 ...
 * Description:  Included for demonstration of bundling a plugin in the Controlled Chaos Design plugin.
 * Version:      0.0.1
 * Text Domain:  sample
 */
