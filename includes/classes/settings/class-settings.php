...
if ( ! defined( 'CCD_FORMS' ) ) {
	define( 'CCD_FORMS', [
		'forms'    => CCD_PATH . 'views/backend/forms/',
		'partials' => CCD_PATH . 'views/backend/forms/partials'
	] );
}
...
class Settings {
	 ...
	 *
	 * @example 'CCDzine\Classes\Admin\Sample_Settings_Page'
	 *
	 * @since  1.0.0
	 * @access protected
	 ...
	 * The fully qualified page class with namespace.
	 *
	 * @example 'CCDzine\Classes\Vendor\Sample_ACF_Options'
	 *
	 * @since  1.0.0
	 * @access protected
	 * @var    string Namespace & class.
...
function get_settings() {
	 ...
	 * subdirectories (`* /`).
	 */
	$dir_file = CCD_PATH . 'includes/settings' . "{/,/*/}" . 'settings-*.php';
